...
-- ----------------------------
BEGIN;
INSERT INTO `menu` VALUES ('it_001', 'PIZZ-MARG-R', 'Pizza Margherita Reg', 'Pizza', 'Regular', 12.00);
INSERT INTO `menu` VALUES ('it_002', 'PIZZ-MARG-L', 'Pizza Margherita Large', 'Pizza', 'Large', 14.00);
INSERT INTO `menu` VALUES ('it_003', 'PIZZ-DIAV-R', 'Pizza Diavola (hot) Reg', 'Pizza', 'Regular', 16.00);
INSERT INTO `menu` VALUES ('it_004', 'PIZZ-DIAV-L', 'Pizza Diavola (hot) Large', 'Pizza', 'Large', 19.00);
INSERT INTO `menu` VALUES ('it_005', 'PIZZ-PARM-R', 'Pizza Parmigiana Reg', 'Pizza', 'Regular', 15.00);
INSERT INTO `menu` VALUES ('it_006', 'PIZZ-PARM-L', 'Pizza Parmigiana Large', 'Pizza', 'Large', 18.00);
INSERT INTO `menu` VALUES ('it_007', 'PIZZ-QUAT-R', 'Pizza Quattro Formaggi Reg', 'Pizza', 'Regular', 16.00);
INSERT INTO `menu` VALUES ('it_008', 'PIZZ-QUAT-L', 'Pizza Quattro Formaggi Large', 'Pizza', 'Large', 19.00);
INSERT INTO `menu` VALUES ('it_009', 'PIZZ-NAPO-R', 'Pizza Napolitana Reg', 'Pizza', 'Regular', 16.00);
INSERT INTO `menu` VALUES ('it_010', 'PIZZ-NAPO-L', 'Pizza Napolitana Large', 'Pizza', 'Large', 18.00);
INSERT INTO `menu` VALUES ('it_011', 'PIZZ-PEPP-R', 'Pizza Pepperoni Reg', 'Pizza', 'Regular', 15.00);
INSERT INTO `menu` VALUES ('it_012', 'PIZZ-PEPP-L', 'Pizza Pepperoni Large', 'Pizza', 'Large', 17.00);
INSERT INTO `menu` VALUES ('it_013', 'PIZZ-SEAF-R', 'Pizza Seafood Reg', 'Pizza', 'Regular', 17.00);
INSERT INTO `menu` VALUES ('it_014', 'PIZZ-SEAF-L', 'Pizza Seafood Large', 'Pizza', 'Large', 20.00);
INSERT INTO `menu` VALUES ('it_015', 'PIZZ-HAWA-R', 'Pizza Hawaiian Reg', 'Pizza', 'Regular', 15.00);
INSERT INTO `menu` VALUES ('it_016', 'PIZZ-HAWA-L', 'Pizza Hawaiian Large', 'Pizza', 'Large', 17.00);
INSERT INTO `menu` VALUES ('it_017', 'SIDE-GARL-R', 'Garlic Bread', 'Side', 'Regular', 6.00);
INSERT INTO `menu` VALUES ('it_018', 'SIDE-CHIC-R', 'Chicken Wings', 'Side', 'Regular', 7.00);
INSERT INTO `menu` VALUES ('it_019', 'SIDE-BREA-R', 'Breadsticks', 'Side', 'Regular', 5.00);
INSERT INTO `menu` VALUES ('it_020', 'SIDE-CAES-R', 'Caesar Salad', 'Side', 'Regular', 7.00);
INSERT INTO `menu` VALUES ('it_021', 'DESS-ICE-CHOC', 'Vanilla Ice cream', 'Dessert', 'Regular', 6.00);
INSERT INTO `menu` VALUES ('it_022', 'DESS-ICE-VANI', 'Chocolate Ice cream', 'Dessert', 'Regular', 6.00);
INSERT INTO `menu` VALUES ('it_023', 'DESS-ICE-STRA', 'Strawberry Ice cream', 'Dessert', 'Regular', 6.00);
INSERT INTO `menu` VALUES ('it_024', 'DESS-ICE-PIST', 'Pistachio Ice cream', 'Dessert', 'Regular', 6.00);
INSERT INTO `menu` VALUES ('it_025', 'DESS-CHOC-BROW', 'Chocolate Brownie', 'Dessert', 'Regular', 5.00);
INSERT INTO `menu` VALUES ('it_026', 'DESS-BANO-PIE', 'Banoffee Pie', 'Dessert', 'Regular', 7.00);
INSERT INTO `menu` VALUES ('it_027', 'DESS-FRUI-SALA', 'Fruit Salad', 'Dessert', 'Regular', 5.00);
INSERT INTO `menu` VALUES ('it_028', 'BEVA-CC-REG33', 'Coca Cola Regular 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_029', 'BEVA-CC-REG1500', 'Coca Cola Regular 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_030', 'BEVA-CC-DIE33', 'Coca Cola Diet 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_031', 'BEVA-CC-DIE1500', 'Coca Cola Diet 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_032', 'BEVA-7U-REG33', 'Sprite Regular 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_033', 'BEVA-7U-REG1500', 'Sprite Regular 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_034', 'BEVA-7U-DIE33', 'Sprite Diet 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_035', 'BEVA-7U-DIE1500', 'Sprite Diet 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_036', 'BEVA-FAN-REG33', 'Fanta Regular 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_037', 'BEVA-FAN-REG1500', 'Fanta Regular 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_038', 'BEVA-FAN-DIE33', 'Fanta Diet 33cl', 'Drink', '33cl', 3.00);
INSERT INTO `menu` VALUES ('it_039', 'BEVA-FAN-DIE1500', 'Fanta Diet 1.5l', 'Drink', '1.5l', 6.00);
INSERT INTO `menu` VALUES ('it_040', 'BEVA-SAN-REG33', 'San Pelligrino 33cl', 'Drink', '33cl', 2.00);
INSERT INTO `menu` VALUES ('it_041', 'BEVA-SAN-REG1500', 'San Pelligrino 1.5l', 'Drink', '1.5l', 4.00);
INSERT INTO `menu` VALUES ('it_042', 'BEVA-PER-REG33', 'Perrier 33cl', 'Drink', '33cl', 2.00);
INSERT INTO `menu` VALUES ('it_043', 'BEVA-PER-REG1500', 'Perrier 1.5l', 'Drink', '1.5l', 4.00);
COMMIT;
